package com.clover.solution.ui.util.listeners;
...
import com.clover.solution.ui.test.BaseTest;
...
public class TestListener extends BaseTest implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        //ExtentTestManager.getTest().log(Status.PASS, "Test is started");
    }
    @Override
    ...
    public void onTestStart(ITestResult iTestResult) {
        ...
        //ExtentTestManager.getTest().log(Status.PASS, getTestMethodName(iTestResult) + "- Test is started");
    }
    @Override
